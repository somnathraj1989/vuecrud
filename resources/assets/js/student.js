  ...
  methods: {
    ...
    createItem: function createItem() {
      ...
      if (input['name'] == '' || input['age'] == '' || input['profession'] == '' ) {
        ...
        this.hasError = true;
        axios.post('/add', input).then(function (response) {
    ...
    editItem: function(){
         ...
         var p_val_1 = document.getElementById('e_profession');
          ...
          axios.post('/edit/' + i_val_1.value, {val_1: n_val_1.value, val_2: a_val_1.value,val_3: p_val_1.value })
            .then(response => {
              this.getVueItems();
